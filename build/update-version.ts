/**
 * fork = require( https://github.com/element-plus/element-plus/blob/dev/build/update-version.ts
 */
...
;(async () => {
  console.log(chalk.yellow(`Updating package.json for folee-vue-hooks`))
